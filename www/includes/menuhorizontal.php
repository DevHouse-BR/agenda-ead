<?php if($_COOKIE["tipo_usuario_agenda"] == "professor"){ //Opções disponíveis para o usuário Professor
?>
...
<table width="775" border="0" cellpadding="0" cellspacing="0" class="menu" bgcolor="#3366FF">
	<tr align="center"><!-- Título de Cada Menu: Quando o mouse passa em cima do título é inserido no <div> respectivo uma tabela contendo o menu em sí -->
		<td height="22" width="11%" style="cursor: hand;" onClick="go(18);"><strong><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif">Agenda</font></strong></td>
	...
	<tr>
		<td><div></div></td><!-- o div fica em branco (sem nenhum código HTML em seu interior, por isso ele fica invisível e pequeno -->
...
<?php if($_COOKIE["tipo_usuario_agenda"] == "aluno"){ //Opções disponíveis para o usuário aluno
?>
