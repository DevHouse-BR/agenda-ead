<!-- Este é um simples formulário para colher o usuario e senha e enviar estas informações para o valida_usuario.php
O unico código em php deste script é para mostrar a mensagem de erro de digitação de senha.-->
			...
			<tr>
				<td align="center" valign="middle">
					<table width="775" height="450" border="0" cellpadding="0" cellspacing="0" class="janela">
						<tr> 
							<td width="720" align="center" bgcolor="#3399FF" style="border-bottom-width: thin; border-bottom-style: solid; border-bottom-color: #0071E1;"><font size="2" face="Arial, Helvetica, sans-serif"><strong>Agenda AMVE</strong></font></td>
									...
									<tr>
										<td width="50%">
											<table width="50%" border="0" cellspacing="1" cellpadding="1">
												...
												<tr> 
													<td align="right" width="30%"><font size="2" face="Arial, Helvetica, sans-serif">Usuario:</font></td>
										...
										<td align="right" width="50%">
											<table width="100%" border="0" cellspacing="1" cellpadding="1">
												<tr>
													...
													das atividades agendadas, seja por e-mail, WAP e/ou quadro 
													de avisos.</font>
													</td>
												</tr>
											</table>
