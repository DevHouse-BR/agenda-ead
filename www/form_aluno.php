<?php
#####################################################################################################################
# Esta é a segunda parte do cadastro de alunos. Este é o formulario onde são digitados as informações e também é	#
# o script que grava estas informações no banco de dados. Tudo isto controlado pela variável $modo					#
#####################################################################################################################
...
if($modo == "salva"){
	...
	if ($executar == "update"){ //Caso seja a alteração de um cadastro existente.
...
if($modo == "update"){ //Mosta as informações do aluno para serem editadas
	require("includes/conectar_mysql.php");
...
<script language="JavaScript">
	function apagar(){
		if(confirm("Deseja apagar o aluno?")){ //A função confirm() exibe uma janela com um botão OK e outro Cancelar e Retorna True para OK e False para Cancelar.
